<!-- SEO Meta -->
<!--
  Title: Panth Advanced Cart for Magento 2 | Free Shipping Bar, Order Notes, Gift Options, Trust Badges | Panth Infotech
  Description: Panth Advanced Cart is a premium Magento 2 extension that turns the default cart page into a high-conversion experience — free shipping progress bar, quantity +/- buttons, trust badges, order notes, cart savings display, estimated delivery dates, gift options, and branded empty cart. Works with Hyva and Luma themes. Compatible with Magento 2.4.4 - 2.4.8 and PHP 8.1 - 8.4. Built by Top Rated Plus Magento developer Kishan Savaliya.
  Keywords: magento 2 advanced cart, magento 2 free shipping bar, magento 2 order notes, magento 2 cart customization, magento 2 gift options, magento 2 trust badges, magento 2 cart page extension, magento 2 quantity buttons, magento 2 estimated delivery, hyva cart extension, luma cart extension, panth advanced cart, panth infotech, hire magento developer, top rated plus upwork
  Author: Kishan Savaliya (Panth Infotech)
  Canonical: https://github.com/mage2sk/module-advancedcart
-->
...
[![Hyva Compatible](https://img.shields.io/badge/Hyva-Compatible-success?logo=alpinedotjs&logoColor=white)](https://www.hyva.io)
[![Luma Compatible](https://img.shields.io/badge/Luma-Compatible-success)]()
[![Packagist](https://img.shields.io/badge/Packagist-mage2kishan%2Fmodule--advancedcart-orange?logo=packagist&logoColor=white)](https://packagist.org/packages/mage2kishan/module-advancedcart)
...
## 🚀 Need Custom Magento 2 Cart or Checkout Work?
...
- [Why Panth Advanced Cart](#why-panth-advanced-cart)
...
1. Download the latest release from [Packagist](https://packagist.org/packages/mage2kishan/module-advancedcart) or the [Adobe Commerce Marketplace](https://commercemarketplace.adobe.com)
...
The module calculates business days (Mon–Fri) from the current date, skipping weekends. It does not currently account for public holidays — if you need that, request a customization via [kishansavaliya.com/get-quote](https://kishansavaliya.com/get-quote).
...
Yes. The source is on GitHub at [github.com/mage2sk/module-advancedcart](https://github.com/mage2sk/module-advancedcart).
...
| GitHub Issues | [github.com/mage2sk/module-advancedcart/issues](https://github.com/mage2sk/module-advancedcart/issues) |
| Upwork (Top Rated Plus) | [Hire Kishan Savaliya](https://www.upwork.com/freelancers/~016dd1767321100e21) |
| Upwork Agency | [Panth Infotech](https://www.upwork.com/agencies/1881421506131960778/) |

Response time: 1–2 business days. Priority support is included with marketplace purchases.

### 💼 Need Custom Cart or Checkout Development?
...
<p align="center">
  <strong>Ready to turn your cart into a conversion machine?</strong><br/>
  <a href="https://kishansavaliya.com/get-quote">
